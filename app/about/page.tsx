...
export default function AboutPage() {
  return (
    ...
    <div>
      <h1 style={{color: "#088F8F", textAlign:"center" }}> Welcome to the site!</h1>
      <h2 style={{color: "#088F8F", textAlign:"center" }}>This site uses an API to fetch images of cats</h2>
      <p style={{color: "#088F8F", textAlign:"center" }}>The cats are abyssinian. According to Wikipedia The Abyssinian is a breed of cat with a distinctive "ticked" tabby coat, in which individual hairs are banded with different colours. They are also known simply as Abys. 
